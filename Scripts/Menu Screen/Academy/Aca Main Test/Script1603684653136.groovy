...
Mobile.tap(findTestObject('SGB/AcademyForm/Upload Image Button/FrontINIC'), 0)
...
Mobile.callTestCase(findTestCase('Menu Screen/Academy/AcademyUploadImage/ChangeMobileArea'), [:], FailureHandling.STOP_ON_FAILURE)
